# AICOUNTLY auth workflow (Purchases)

How Purchases signs a user in. This is the shared AICOUNTLY SaaS flow — the same
...
`purchases` out of either hostname, and `isSandboxHost()` picks the portal.
