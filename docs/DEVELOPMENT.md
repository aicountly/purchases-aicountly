...
PURCHASE_APP_URL=http://127.0.0.1:5173 npm --prefix web run test:returns
```

Both browser suites **reset the database and seed their own fixtures**, so they
cannot be run against anything you want to keep.
